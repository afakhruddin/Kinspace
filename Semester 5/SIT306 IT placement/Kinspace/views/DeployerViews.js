...
exports.GetHand = class extends React.Component {
  render() {
    ...
    return (
      ...
      <div>
        <h2>Ana, it's time to select the badge you'd like to collect:</h2>
        {hand ? '' : ''}
        <br />
...
The next step is to verify how which modules you've completed.</h2>
...
exports.WaitingForAttacher = class extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <h2>Ana, please copy and paste this magic code so we can join you.</h2>
